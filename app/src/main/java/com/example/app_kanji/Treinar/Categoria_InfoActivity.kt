...
class Categoria_InfoActivity : AppCompatActivity() {
    ...
    private var kanjiList = mutableListOf<Kanji>() // Lista de kanjis
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.e("Categoria_InfoActivity", "Kanji ID recebido: $kanjiID")
        ...
        populateKanjiList {
            ...
            if (kanji != null) {
                ...
                Log.e("Categoria_Info", "Kanji com ID $kanjiID não encontrado.")
            }
        }
